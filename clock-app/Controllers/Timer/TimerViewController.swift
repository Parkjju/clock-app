...
class TimerViewController: UIViewController {
    ...
    @IBAction func startButtonTapped(_ sender: UIButton) {
        ...
        guard isOn == true else {
            ...
            NotificationService.sharedInstance.requestAlarmNotification(nil, type: "Timer", title: "시계", subtitle: "타이머", sound: translateSoundName(text: ringtoneLabel.text!), withInterval: getAlertTimeWithTimeInterval() + 1, notificationId: notificationId, nil)
            return
        }
